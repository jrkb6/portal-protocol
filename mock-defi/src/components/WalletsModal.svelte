<script>
    import {showLoginModal} from "../stores.ts";
    import {connectWallet} from "../walletFunctions.ts";
    import {web3Store} from "../stores.ts";

    import ConnectPortal from "./ConnectPortal.svelte";
...
{#if $showLoginModal}
    <div id="crypto-modal" tabindex="-1"
         class="fixed pin overflow-x top-0 right-0 left-0 z-50 overflow-auto bg-smoke-light grid justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button" on:click={closeWalletsModal}
